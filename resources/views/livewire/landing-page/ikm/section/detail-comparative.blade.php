...
<div class="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl shadow-sm overflow-hidden mb-4">
    ...
    <div class="p-5 sm:p-6 border-b border-slate-100 dark:border-slate-700">
        <p class="text-[10px] font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500 mb-1">Analisis Riwayat Detail</p>
        <h3 class="text-base font-black text-slate-800 dark:text-white">Perbandingan 9 Unsur Antar Periode</h3>
        <p class="text-xs text-slate-400 dark:text-slate-500 mt-1">Geser ke samping untuk melihat riwayat lebih lengkap</p>
    </div>
        ...
        <table class="w-full border-collapse">
            <thead>
                <tr class="bg-slate-50 dark:bg-slate-700/50 border-b border-slate-100 dark:border-slate-700">
                    {{-- Sticky unsur header --}}
                    <th class="sticky left-0 z-10 bg-slate-50 dark:bg-slate-700/50 py-3 px-3 sm:px-5 text-left text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-slate-400 dark:text-slate-500 border-r border-slate-100 dark:border-slate-700 min-w-[140px] sm:min-w-[180px]">
                        9 Unsur Pelayanan
                    </th>
            ...
            <tbody>
                <template x-for="idx in 9" :key="idx">
                    <tr class="border-b border-slate-100 dark:border-slate-700 last:border-0 hover:bg-slate-50/50 dark:hover:bg-slate-700/20 transition-colors">
                        {{-- Sticky unsur label --}}
                        <td class="sticky left-0 z-10 bg-white dark:bg-slate-800 py-3 px-3 sm:px-5 border-r border-slate-100 dark:border-slate-700">
                            <div class="flex items-center gap-2 sm:gap-2.5">
                                <span class="w-4 h-4 sm:w-5 sm:h-5 rounded-md flex items-center justify-center text-[9px] sm:text-[10px] font-black shrink-0 bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400 tabular-nums"
                                    x-text="idx"></span>
