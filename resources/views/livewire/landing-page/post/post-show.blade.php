<div class="min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
    ...
    <div class="bg-linear-to-br from-[#0c3a47] via-[#0d6b7a] to-[#075985] pt-12 pb-24 relative overflow-hidden">
        <div class="absolute inset-0 opacity-10">
            <svg class="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                <defs><pattern id="grid-show" width="40" height="40" patternUnits="userSpaceOnUse"><path d="M 40 0 L 0 0 0 40" fill="none" stroke="white" stroke-width="1" /></pattern></defs>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            @if($post->categorySlug)
                <span class="inline-block px-3 py-1 text-[10px] font-bold rounded-lg uppercase tracking-tight bg-white/15 text-white mb-4 backdrop-blur-sm">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-12 pb-20 relative z-10">
        <div class="lg:grid lg:grid-cols-12 lg:gap-8 items-start">
            ...
            {{-- Main Article Column --}}
            <div class="lg:col-span-8 bg-white dark:bg-slate-800 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-700 overflow-hidden">
                {{-- Thumbnail --}}
                ...
                <div class="p-8 sm:p-12">
                    ...
                    <div class="mt-12 pt-8 border-t border-slate-100 dark:border-slate-700 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            ...
            <aside class="hidden lg:block lg:col-span-4 sticky top-8">
                <x-bale-organisasi::suggested-posts :posts="$this->suggestedPosts" :currentId="$post->id" variant="sidebar" />
            </aside>
            
            {{-- Mobile suggested posts (at bottom) --}}
            <div class="lg:hidden mt-8">
                <x-bale-organisasi::suggested-posts :posts="$this->suggestedPosts" :currentId="$post->id" variant="grid" />
            </div>
        </div>
    </div>
</div>